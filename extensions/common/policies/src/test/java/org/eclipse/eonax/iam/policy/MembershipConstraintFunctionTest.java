...
import static org.eclipse.eonax.iam.policy.AbstractDynamicCredentialConstraintFunction.VC_CLAIM;
import static org.eclipse.eonax.iam.policy.MembershipConstraintFunction.ACTIVE;
...
class MembershipConstraintFunctionTest {
    ...
    void evaluate_success() {
        ...
        var result = function.evaluate(EONAX_MEMBERSHIP_CONSTRAINT, Operator.EQ, ACTIVE, null, context);
