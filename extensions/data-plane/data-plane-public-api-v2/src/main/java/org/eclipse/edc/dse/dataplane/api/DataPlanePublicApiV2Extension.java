...
import org.eclipse.edc.dse.dataplane.api.controller.DataPlanePublicApiV2Controller;
 ...
 *
 * the data-plane http proxy implementation will need to be provided from adopters.
 */
...
public class DataPlanePublicApiV2Extension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        if (publicApiResponseUrl != null) {
            generatorService.addGeneratorFunction("HttpData", dataAddress -> Endpoint.url(publicApiResponseUrl));
        }
