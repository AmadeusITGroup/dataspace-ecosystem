...
package org.eclipse.edc.eonax.agreements.retirement.spi.service;
...
public interface AgreementsRetirementService {
    ...
    /**
     * Given a contract agreement id, verifies if a corresponding {@link AgreementsRetirementEntry} exists in the {@link org.eclipse.edc.eonax.agreements.retirement.spi.store.AgreementsRetirementStore}.
     *
    ...
    /**
     * Saves an {@link AgreementsRetirementEntry} in the {@link org.eclipse.edc.eonax.agreements.retirement.spi.store.AgreementsRetirementStore}.
     *
    ...
    /**
     * Given a contract agreement id, removes its matching {@link AgreementsRetirementEntry} from the {@link org.eclipse.edc.eonax.agreements.retirement.spi.store.AgreementsRetirementStore}.
     *
