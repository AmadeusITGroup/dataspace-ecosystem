...
package org.eclipse.eonax.edc.agreements.retirement.spi.types;
...
import static org.eclipse.edc.spi.core.CoreConstants.EONAX_NS;

/**
 * Representation of a Contract Agreement Retirement entry, to be stored in the {@link org.eclipse.eonax.edc.agreements.retirement.spi.store.AgreementsRetirementStore}.
 */
public class AgreementsRetirementEntry extends Entity {
    ...
    public static final String AR_ENTRY_REASON = EONAX_NS + "reason";
    public static final String AR_ENTRY_RETIREMENT_DATE = EONAX_NS + "agreementRetirementDate";
