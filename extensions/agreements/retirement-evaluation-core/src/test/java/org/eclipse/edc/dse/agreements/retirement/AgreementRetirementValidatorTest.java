...
package org.eclipse.edc.dse.agreements.retirement;
...
class AgreementRetirementValidatorTest {
    ...
    private org.eclipse.edc.dse.agreements.retirement.AgreementRetirementValidator validator;
    private final AgreementsRetirementService service = mock();
    private final PolicyContext context = mock();

    @BeforeEach
    public void setup() {
        validator = new org.eclipse.edc.dse.agreements.retirement.AgreementRetirementValidator(service);
    }
