...
import org.eclipse.eonax.spi.telemetrystorage.TelemetryEventStoreTestBase;
import org.eclipse.eonax.telemetrystorage.store.sql.schema.BaseSqlDialectStatements;
import org.eclipse.eonax.telemetrystorage.store.sql.schema.postgres.PostgresDialectStatements;
...
class PostgresTelemetryEventStoreTest extends TelemetryEventStoreTestBase {
    ...
    void setUp(PostgresqlStoreSetupExtension extension, QueryExecutor queryExecutor) throws IOException {
        ...
        extension.runQuery("INSERT INTO participant_id (id, email, timestamp) VALUES ('participant1', 'participant1@example.com', now())");
        extension.runQuery("INSERT INTO participant_id (id, email, timestamp) VALUES ('participant2', 'participant2@example.com', now())");
